        ...
        URLSession.shared.dataTask(with: downloadURL) { (data, urlResponse , error) in
          ...
          do{
            ...
            func generateRandomDataEntries() -> [DataEntry] {
                let colors = [#colorLiteral(red: 0.7073796988, green: 0.916798532, blue: 0.3351904154, alpha: 1), #colorLiteral(red: 0.2392156869, green: 0.6745098233, blue: 0.9686274529, alpha: 1), #colorLiteral(red: 0.501960814, green: 0.501960814, blue: 0.501960814, alpha: 1), #colorLiteral(red: 1, green: 0.8496686816, blue: 0, alpha: 1), #colorLiteral(red: 0.9372549057, green: 0.3490196168, blue: 0.1921568662, alpha: 1), #colorLiteral(red: 0.8415471315, green: 0.3140499294, blue: 0.3379223943, alpha: 1), #colorLiteral(red: 0.3647058904, green: 0.06666667014, blue: 0.9686274529, alpha: 1)]
                           var num = 0;
                           var result: [DataEntry] = []
                           var value = 500
